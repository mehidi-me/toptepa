...
color: '#d9a2a2',
textAlign: 'center',
lineHeight: '1.5'}}><b style={{color: '#d9a2a2'}}>ডেটা সুরক্ষা:</b> ফোন নাম্বার শুধুমাত্র ভেরিফিকেশনের জন্য নেওয়া হচ্ছে, এটি কোন প্রকার প্রমোশনাল কাজে ব্যবহার করা হবে না। বিজয়ী ঘোষণার পর আমাদের ডেটাবেজ সম্পূর্ণভাবে ডিলিট করা হবে, সুতরাং আপনার ডাটা গোপনীয়তা বজায় থাকবে।</p>
          </div>
